            ...
            <div class="container">
                ...
                <nav class="desktop">
                    <ul>
                        ...
                        <li><span></span><a href="#two">Fazer Doações</a></li>
                        <li><span></span><a href="#tree"></a>Duvidas</li>
                    </ul>
                </nav>
                <nav class="mobile">
                    ...
                    <ul>
                        ...
                        <li><span></span><a href="#one">Informações</a></li>
                        <li><span></span><a href="#two">Duvidas</a></li>
                        <li><span></span><a href="#tree">Login</a></li>
                    </ul>
                </nav>

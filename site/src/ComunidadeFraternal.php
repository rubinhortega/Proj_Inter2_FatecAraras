...
<body>
    <section class="header-master">
		...
		<li><a href="ComunidadeFraternal.php">Comunidade Fraternal</a></li><br>
                ...
                <div class="two">
                    <br><br><br>
                <p style="text-align: justify;">Acreditamos no reencontro. No Brasil, uma pessoa desaparece a cada 3 minutos. São mais de 200 mil desaparecidos por ano. Nosso trabalho é trazer esperança para as famílias que estão em busca dessas pessoas. </p>

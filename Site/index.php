        ...
        <div class="content-header">
            <div class="container1">
                <div class="one">
                    ...
                    <p>
                        Aqui além de você ter acesso as últimas notícias sobre os desastres que 
                        ocorreram, você poderá também encontrar alguém desaparecido em um desastre!
            ...
            <div style="margin-top: 50px; padding: 0 30px;" class="estapas__single tree">
                ...
                <div class="etapas__group2">
                    ...
                    <div class="etapas__descricao">
                        ...
                        <p>Se não há mais o que fazer e você estiver no meio de uma situação de perigo, coloque sua cabeça no chão e a proteja com suas mãos. A posição acima resguarda suas partes mais frágeis. 
                    </p>
                    </div>
                    <div class="clear"></div>
                    <!--estpas__descricao-->
